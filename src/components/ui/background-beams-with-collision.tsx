...
const AnimatedBeam = ({
    ...
    if (!collision.detected || !collision.coordinates) return null;
...
const Explosion = ({ style, className }: { style: React.CSSProperties; className?: string }) => {
    ...
    return (
        <div style={style} className={cn('absolute z-50 h-2 w-2', className)}>
            <motion.div
                initial={{ opacity: 0 }}
